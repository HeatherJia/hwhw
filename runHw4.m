...
signAcademicHonestyPolicy('Heather Jia', 'yjia42');
...
portrait_pts = [0 0; 326 0; 0 400; 326 400];
bg_pts = [97 17; 278 71; 85 439; 287 425];
...
%
impl = 'MATLAB'; % change to 'MATLAB' to use native MATLAB implementation
